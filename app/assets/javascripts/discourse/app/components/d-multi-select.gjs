  ...
  <template>
    ...
    >
      <:trigger>
        ...
        {{else}}
          <span class="d-multi-select-trigger__placeholder">Select options</span>
        {{/if}}
      ...
      <:content>
        <DropdownMenu class="d-multi-select__content" as |menu|>
          ...
          >
            <:empty><div class="d-multi-select__search-no-results">No results</div></:empty>
            <:loading>
