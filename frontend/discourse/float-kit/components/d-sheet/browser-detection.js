/**
 * Browser detection utilities (like Silk's ec/eu variables).
 * Used for platform-specific behavior, particularly snap accelerator calculations.
 * See Silk source.js lines 2731-2763.
 */
...
// Cache browser detection result (runs once)
