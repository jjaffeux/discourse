                      ...
                      <div class="ExampleSheetWithKeyboard-info">
                        ...
                        <div class="ExampleSheetWithKeyboard-form">
                          <div class="ExampleSheetWithKeyboard-field">
                            ...
                            <p
                              class="ExampleSheetWithKeyboard-labelDescription"
                            >
                            ...
                            <input
                              ...
                              {{on
                                "input"
                                (fn this.updateFormField "formName")
                              }}
                            />
                          </div>
                          <div class="ExampleSheetWithKeyboard-field">
                            ...
                            <input
                              ...
                              {{on
                                "input"
                                (fn this.updateFormField "formBrand")
                              }}
                            />
                          </div>
                          <div class="ExampleSheetWithKeyboard-field">
                            ...
                            <input
                              ...
                              {{on
                                "input"
                                (fn this.updateFormField "formType")
                              }}
                            />
                          </div>
                          <div
                          ...
                          <div class="ExampleSheetWithKeyboard-field">
                            ...
                            <input
                              ...
                              {{on
                                "input"
                                (fn this.updateFormField "formPrice")
                              }}
                            />
                          </div>
                          <div
