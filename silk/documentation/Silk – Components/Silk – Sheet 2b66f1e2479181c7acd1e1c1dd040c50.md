...
- See [Silk – Composition](Silk%20%E2%80%93%20Composition%202b66f1e2479181e08551edf6efe6e0ac.md) for more information.
...
See [asChild](Silk%20%E2%80%93%20Sheet%202b66f1e2479181c7acd1e1c1dd040c50.md) on `<Sheet.Root>`.
...
See [travelAnimation](Silk%20%E2%80%93%20Sheet%202b66f1e2479181c7acd1e1c1dd040c50.md) on `<Sheet.Outlet>`.

### stackingAnimation

See [stackingAnimation](Silk%20%E2%80%93%20Sheet%202b66f1e2479181c7acd1e1c1dd040c50.md) on `<Sheet.Outlet>`.
...
See [enteringAnimationSettings](Silk%20%E2%80%93%20Sheet%202b66f1e2479181c7acd1e1c1dd040c50.md).
...
- It prevents `<body>` from being scrollable, as expected. As a result, scrollbars are removed, and a CSS padding is added to compensate for it. In order to adjust the position of elements using `fixed` positioning, please use the Fixed component. See [Silk – Fixed](Silk%20%E2%80%93%20Fixed%202b66f1e247918132a8dcc1e2c89e4976.md).
- Use the Island component to wrap any element that you want the user to be able to interact with when this prop is set to `true`. See [Silk – Island](Silk%20%E2%80%93%20Island%202b66f1e24791813da68cf9256d41c79c.md).
...
- If you need to update the  `theme-color` while the Sheet is presented, you must use the [`updateThemeColor`](Silk%20%E2%80%93%20updateThemeColor%202b66f1e2479181ff9374d05a2a37f237.md) function so only the underlying color gets updated, preserving the dimming.
...
See [onPress](Silk%20%E2%80%93%20Sheet%202b66f1e2479181c7acd1e1c1dd040c50.md) on `<Sheet.Trigger>`.
