...
These props come with some limitations at the moment. Read more about the `presented` and `onPresentedChange` props on the [Sheet documentation page](Silk%20%E2%80%93%20Sheet%202b66f1e2479181c7acd1e1c1dd040c50.md).
...
These props come with some limitations at the moment. Read more about the `activeDetent` and `onActiveDetentChange` props on the [Sheet documentation page](Silk%20%E2%80%93%20Sheet%202b66f1e2479181c7acd1e1c1dd040c50.md).